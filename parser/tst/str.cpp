...
static_assert(noexcept(match_any_of("ABC")("")));
...
static_assert(noexcept(match_range('a', 'z')("")));
...
static_assert(noexcept(match_none_of("ABC")("")));
